            ...
            if($_POST) {
                ...
                if(!$error) {
                    try {
                        ...
                        $sql = "insert into `pocketwaiter`.`company` (`name`, `email`, `desc`, `website`, `phone`, `address`, `logo`) values (?, ?, ?, ?, ?, ?, ?);";
                        $sth = $DBH->prepare($sql);
                        ...
                        $sth->bindParam(7, $file, PDO::PARAM_INT);
        ...
        ?>
            ...
            <div role="main" class="ui-content">
                ...
                <form enctype="multipart/form-data" name="register_company_form" action="register_company.php" method="post" onsubmit="return validateMyForm();">
                    ...
                    <input type="file" data-clear-btn="true" name="logo" id="logo">
