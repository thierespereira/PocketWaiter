    ...
    <body>
        <div data-role="page" style="width=100%; margin:0;" data-theme="b">
            <?php
                ...
                if($status == 'Open') {
                    echo '<center><button id="update_status" name="update_status" data-transition="slide" class="ui-btn ui-icon-tag ui-btn-icon-left ui-btn-b">Mark as "Being Prepared..."</button></center>';
                } else {
