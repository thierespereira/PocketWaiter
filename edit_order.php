    ...
    <body>
        <div data-role="page" style="width=100%; margin:0;" data-theme="b">
            <?php
                ...
                try {
                    ...
                    if($_POST) {
                        if(isset($_POST['update_status'])) {
                            $sql = 'update `order` set `status`= "Shipped" where  `id` = ?;';
                            $sth = $DBH->prepare($sql);
                ...
                if($status == 'Open') {
                    echo '<center><button id="update_status" name="update_status" class="ui-btn ui-icon-tag ui-btn-icon-left ui-btn-b">Mark as Shipped</button></center>';
