        ...
        <div data-role="page" style="width=100%; margin:0;" data-theme="b">
            ...
            <script type="text/javascript" language="javascript">
                ...
                function validateMyForm() {
                    form = document.forms['edit_product_form'];
                    $("#errorMessage").html('');
                    var ret = true;
            ...
            <div role="main" class="ui-content">
                ...
                <form enctype="multipart/form-data" name="edit_product_form" data-ajax="false" action="edit_product.php?id=<?php echo $_GET['id'] ?>"  method="post" onsubmit="return validateMyForm(this);">
